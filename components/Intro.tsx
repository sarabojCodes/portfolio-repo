  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          className="bg-white p-4 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110  active:scale-105 transition
                     group cursor-pointer  borderBlack"
        >
          <BsLinkedin />
        </a>
